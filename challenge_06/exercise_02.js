...
console.log(`Sunrise is at: ${padHour(astronomy.sunrise)}`);
console.log(`Sunset is at: ${padHour(astronomy.sunset)}`);

function padHour(input){

    let [hours, rest] = input.split(":");
    let [minutes, period] = rest.split(" ");
